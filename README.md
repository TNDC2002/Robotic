...
- `--cpus-per-task=8`
- `--mem=128G`
- `--time=0` (you should set this to a valid walltime for your cluster)
- training command uses `--n-envs 8`

If you want `16` CPU cores and `--n-envs 16`, edit `submit_train_nav_rl.slurm` accordingly (and set `--time` to something non-zero).
